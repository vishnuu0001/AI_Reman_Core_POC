...
import { CheckCircle, XCircle, Shield, Clock, BarChart2, RefreshCw } from 'lucide-react';
...
const ResultCard = ({ result, loading, onReset }) => {
    return (
        <div className="card results-section" style={{minHeight: '400px', display:'flex', flexDirection:'column', height: '100%'}}>
            ...
            {result && !loading && (
                <div className="results-content fade-in" style={{display: 'flex', flexDirection: 'column', height: '100%'}}>
                ...
                {result.warrantyMonths} <small>Mo</small>
                    ...
                    <div className="defects-list" style={{flex: 1}}>
                    ...
                    <button
                        onClick={onReset}
                        style={{
                            marginTop: '20px', width: '100%', padding: '16px', background: '#334155', color: 'white',
                            border: 'none', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer',
                            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px'
                        }}
                    >
                        <RefreshCw size={18}/> START NEW INSPECTION
                    </button>
